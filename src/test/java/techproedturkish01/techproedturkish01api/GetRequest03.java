...
public class GetRequest03 {
	...
	*/
	...
	public void get01() {
		...
		statusCode(200).
		contentType("application/json").
		body("firstname", Matchers.equalTo("Sally"),//Matchers bir karsilastima klassi 
			 "lastname", Matchers.equalTo("Jackson"),//tek body ile  , virgul ile calisilir butun condtion lar konulur.
			 "totalprice", Matchers.equalTo(5000),
			 "depositpaid", Matchers.equalTo(true),
			 "bookingdates.checkin", Matchers.equalTo("2015-02-03"),//json da . koyup iceri girilir
