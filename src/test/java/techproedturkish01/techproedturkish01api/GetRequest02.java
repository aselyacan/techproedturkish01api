...
public class GetRequest02 {
	...
	/*
	 ...
	 and()  Accept Type'i "application/json" dir.// on kosul demek 
	...
	*/
	...
	public void get01() {		
		...
		given().//given den sonra accept type hangi data type ile calisalacaksa o   yazilir 
	...
	@Test// negative seneryolarda content type olmaz ...
	public void get02() {
	...
	@Test
	public void get03() {
		Response response = given().//response  modeliyle calismak daha sik ve %90 butun data onun icinde
                            when().
                               get("https://restful-booker.herokuapp.com/booking/1001");
		...
		assertTrue(response.asString().contains("Not Found"));//response asString ile stringe cevir 
		//ve contains metho kullan
